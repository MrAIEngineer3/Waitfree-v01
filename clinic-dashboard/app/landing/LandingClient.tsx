    ...
    <div className="relative min-h-screen flex flex-col">
      ...
      <main id="main" className="flex-1 w-full max-w-7xl mx-auto px-4 sm:px-5 pb-32">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8 max-w-6xl mx-auto">
            <Card variant="soft" padding="lg" className="border-2 border-red-100 hover:border-red-200/60 hover:shadow-md hover:-translate-y-0.5 transition-all duration-[800ms] ease-out">
            ...
            <Card variant="soft" padding="lg" className="border-2 border-green-100 bg-gradient-to-br from-green-50/50 to-cyan-50/50 hover:border-green-200/60 hover:shadow-md hover:-translate-y-0.5 transition-all duration-[800ms] ease-out">
              <div className="flex items-center gap-3 mb-6">
      ...
      <footer className={`relative mt-auto overflow-hidden bg-gradient-to-b from-white/90 to-slate-50/90 backdrop-blur-xl border-t border-white/60 shadow-[0_-20px_60px_-40px_rgba(15,23,42,0.45)] transition-all duration-700 ${mounted ? 'opacity-100' : 'opacity-0'}`} style={{ transitionDelay: '1700ms' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-5 py-12 sm:py-16">
          <div className="relative overflow-hidden rounded-2xl border border-white/40 bg-white/90 shadow-lg p-6 sm:p-8 lg:p-10 flex flex-col lg:flex-row gap-6 lg:gap-10 mb-12">
