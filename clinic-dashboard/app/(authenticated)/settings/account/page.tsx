    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground mt-1">Manage your session and account settings</p>
        </div>
      </div>
        ...
        <CardContent className="space-y-4 pt-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">End your current session safely. You can sign back in anytime.</p>
            </div>
          </div>
          <div className="pt-2">
