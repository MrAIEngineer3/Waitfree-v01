	...
	return (
		<div className="space-y-6 pb-8">
			...
			<div className="relative">
				<div className="absolute inset-0 bg-gradient-to-br from-blue-50/50 via-indigo-50/30 to-transparent rounded-3xl blur-3xl" />
						...
						<div className="space-y-2">
							<div className="flex items-center gap-3">
								...
								<div>
									...
									<p className="text-sm text-gray-600 mt-0.5">Insights and performance metrics for {clinicName || 'your clinic'}</p>
								</div>
							</div>
						</div>
			...
			{hasContext ? (
				<div className="space-y-6">
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<div className="group relative bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300">
							...
							<div className="relative space-y-4">
								<div className="flex items-center justify-between">
									<div className="flex items-center gap-3">
										...
										<h3 className="text-lg font-semibold text-gray-900">Queue Efficiency</h3>
									</div>
								...
								<div className="space-y-3">
									<div className="flex items-baseline justify-between">
										...
										<span className="text-2xl font-bold text-gray-900">12<span className="text-sm font-normal text-gray-500">min</span></span>
									</div>
									<div className="w-full bg-gray-100 rounded-full h-2">
										<div className="bg-gradient-to-r from-emerald-500 to-teal-500 h-2 rounded-full" style={{width: '75%'}} />
									</div>
									<p className="text-xs text-gray-500">Coming soon: Real-time wait time tracking</p>
								</div>
							</div>
						</div>
							...
							<div className="relative space-y-4">
								...
								<div className="space-y-3">
									<div className="flex items-baseline justify-between">
										...
										<span className="text-2xl font-bold text-gray-900">10-12<span className="text-sm font-normal text-gray-500">AM</span></span>
									</div>
									<div className="flex gap-1">
										{[30, 60, 45, 80, 100, 95, 70, 50].map((h, i) => (
											<div key={i} className="flex-1 bg-gray-100 rounded-sm" style={{height: '40px', display: 'flex', alignItems: 'flex-end'}}>
												<div className="w-full bg-gradient-to-t from-purple-500 to-pink-500 rounded-sm" style={{height: `${h}%`}} />
											</div>
										))}
									</div>
									<p className="text-xs text-gray-500">Coming soon: Hourly patient distribution</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8 shadow-lg">
						<div className="space-y-6">
							<div className="flex items-start justify-between">
								<div className="space-y-2">
									<h3 className="text-xl font-semibold text-white">Advanced Analytics</h3>
									<p className="text-sm text-gray-400">Powerful insights coming soon to help optimize your clinic operations</p>
								</div>
				...
				<div className="bg-white border border-gray-200 rounded-2xl p-12 shadow-sm">
					<div className="text-center space-y-4 max-w-md mx-auto">
						...
						<h3 className="text-lg font-semibold text-gray-900">Complete Clinic Setup</h3>
						<p className="text-sm text-gray-600">Set up your clinic profile to unlock detailed analytics and insights about your practice.</p>
					</div>
				</div>
			)}
		</div>
