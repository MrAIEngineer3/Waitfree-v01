...
exports.isPatientResolverV1Enabled = exports.currentPatientResolverFlagSnapshot = void 0;
...
const shouldBypassCache = isTruthyEnv(process.env.FUNCTIONS_EMULATOR) ||
    process.env.NODE_ENV === 'test' ||
    process.env.VITEST === 'true' ||
    typeof process.env.FIRESTORE_EMULATOR_HOST === 'string';
let cachedSnapshot = null;
const normalizeRolloutStage = (value) => {
...
const fetchFlagFromFirestore = async () => {
...
const currentPatientResolverFlagSnapshot = async (options = {}) => {
...
exports.currentPatientResolverFlagSnapshot = currentPatientResolverFlagSnapshot;
const isPatientResolverV1Enabled = async (options = {}) => {
    const snapshot = await (0, exports.currentPatientResolverFlagSnapshot)({ forceReload: options.forceReload });
...
exports.isPatientResolverV1Enabled = isPatientResolverV1Enabled;
