...
exports.normalizePatientMetadata = void 0;
...
const sanitizeStringList = (value, maxEntries, entryMaxLength) => {
...
const sanitizeMetadataRecord = (value) => {
    ...
    for (const [rawKey, rawValue] of Object.entries(value)) {
        ...
        if (constants_1.PATIENT_METADATA_RESERVED_KEYS.has(key)) {
            continue;
        }
...
const normalizePatientMetadata = (input) => {
    const metadata = {
...
exports.normalizePatientMetadata = normalizePatientMetadata;
